...
export const zhHant: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        diffStyle: '差異檢視',
        diffStyleDescription: '以單欄或並排方式顯示差異。並排檢視僅在 Web 上可用。',
        diffStyleOptions: {
            unified: '單欄',
            split: '並排',
        },
    ...
    sessionInfo: {
        ...
        updateCliInstructions: '此 fork 未發佈到 npm，請從原始碼更新 CLI（參見儲存庫 README）。',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `happy daemon status` 進行診斷\n• CLI 是否為最新版本？此 fork 透過原始碼更新——拉取最新程式碼並重新建置（參見儲存庫 README）',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
